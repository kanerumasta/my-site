...
export default function BlogTabs({ posts }: { posts: TBlogPost[] }) {
  ...
  return (
    <>
      {/* TABS */}
      <div role="tablist" aria-label="Filter posts" className="z-20 flex gap-4 mb-8 border-b sticky top-15 pt-2 bg-background/90 backdrop-blur border-foreground/10">
        <button
          role="tab"
